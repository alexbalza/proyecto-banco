...
public class CustomerController {
  ...
  @GetMapping("find-all-customertype/{customerTypeId}")
  public Flux<Customer> getCustomersByCustomerType(@PathVariable(value = "customerTypeId") ObjectId customerTypeId){
    log.info("Ingreso a getCustomersByCustomerType");
    return customerService.getCustomersByCustomerType(customerTypeId);
  }
